...
const ICONS: Record<string, string> = {
  ...
  'figure.seated.side': `<svg xmlns="http://www.w3.org/2000/svg" width="${ICON_SIZE}" height="${ICON_SIZE}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2.5"/><path d="M8 21h8"/><path d="M12 21v-5"/><path d="M9 12l3 4 3-4"/><path d="M7 12h10"/></svg>`,
